  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(4) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `orders` (`id` TEXT NOT NULL, `title` TEXT NOT NULL, `clientName` TEXT NOT NULL, `filament` TEXT NOT NULL, `printer` TEXT NOT NULL, `printerId` TEXT NOT NULL, `printerNameSnapshot` TEXT NOT NULL, `printTimeHours` INTEGER NOT NULL, `printTimeMinutes` INTEGER NOT NULL, `weightGramsPerUnit` INTEGER NOT NULL, `quantity` INTEGER NOT NULL, `designType` TEXT NOT NULL, `color` TEXT NOT NULL, `isFriend` INTEGER NOT NULL, `status` TEXT NOT NULL, `createdAt` TEXT NOT NULL, `totalComputed` REAL NOT NULL, `quoteDate` TEXT NOT NULL, `validityDays` INTEGER NOT NULL, `deliveryBusinessDays` INTEGER NOT NULL, `deliveryDate` TEXT NOT NULL, `paymentType` TEXT NOT NULL, `depositPercentage` INTEGER NOT NULL, `finishType` TEXT NOT NULL, `notes` TEXT NOT NULL, `imageUri` TEXT NOT NULL, `subtotal` REAL NOT NULL, `margenMonto` REAL NOT NULL, `descuentoCantidad` REAL NOT NULL, `descuentoAmigo` REAL NOT NULL, `totalFinal` REAL NOT NULL, PRIMARY KEY(`id`))");
        ...
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'cc8bb8f70219dbf89c80d61eefff4a36')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        final HashMap<String, TableInfo.Column> _columnsOrders = new HashMap<String, TableInfo.Column>(31);
        ...
        _columnsOrders.put("imageUri", new TableInfo.Column("imageUri", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
    ...
    }, "cc8bb8f70219dbf89c80d61eefff4a36", "876d31ecce7d7efa8dc759c6d33096a7");
